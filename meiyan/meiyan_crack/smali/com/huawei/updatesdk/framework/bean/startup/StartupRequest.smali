...
.method private constructor <init>()V
    ...
    iput v2, p0, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->isSubUser_:I

    const/4 v0, 0x3

    iput v0, p0, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->rsaVer_:I

    iput-object v1, p0, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->emuiVer_:Ljava/lang/String;

    iput v2, p0, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->emuiApiLevel_:I
...
.method private static getSysteBit()I
    ...
    :cond_0
    const-string/jumbo v1, "StartupRequest"
...
.method public static newInstance()Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;
    ...
    new-instance v3, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;

    invoke-direct {v3}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;-><init>()V
    ...
    invoke-virtual {v3, v1}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setSerial(Z)V

    invoke-virtual {v3, v5}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setSign_(Ljava/lang/String;)V

    invoke-virtual {v3}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->getHcrId_()Ljava/lang/String;
    ...
    invoke-virtual {v3, v5}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setHcrId_(Ljava/lang/String;)V

    :cond_0
    invoke-virtual {v3, v2}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setNeedSign(Z)V

    const-string/jumbo v4, "client.front2"

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setMethod_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->j()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setFirmwareVersion_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->d()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setLocale_(Ljava/lang/String;)V

    invoke-virtual {v3, v1}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setZone_(I)V

    invoke-static {v0}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setVersion_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->b()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setBuildNumber_(Ljava/lang/String;)V

    sget-object v4, Landroid/os/Build;->MODEL:Ljava/lang/String;

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setPhoneType_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->c()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setDensity_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->e()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setScreen_(Ljava/lang/String;)V

    invoke-static {v0}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->c(Landroid/content/Context;)I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setVersionCode_(I)V
    ...
    :goto_0
    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setGmsSupport_(I)V

    const-string/jumbo v0, "true"

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setTheme_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/sdk/a/c/b/a;->e()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setResolution_(Ljava/lang/String;)V

    const-string/jumbo v0, "storeApi3"

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setStoreApi(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setPackageName_(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setSignSecretKey(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/service/a/b;->a()Lcom/huawei/updatesdk/service/a/b;

    move-result-object v0

    invoke-virtual {v0}, Lcom/huawei/updatesdk/service/a/b;->j()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setEncryptSignKey_(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setSecretKey(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/service/a/b;->a()Lcom/huawei/updatesdk/service/a/b;

    move-result-object v0

    invoke-virtual {v0}, Lcom/huawei/updatesdk/service/a/b;->k()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setEncryptKey_(Ljava/lang/String;)V

    invoke-static {}, Lcom/huawei/updatesdk/support/f/c;->a()Lcom/huawei/updatesdk/support/f/c;

    move-result-object v0

    invoke-virtual {v0}, Lcom/huawei/updatesdk/support/f/c;->c()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setEmuiVer_(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setEmuiApiLevel_(I)V

    const/4 v0, 0x3

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setRsaVer_(I)V
    ...
    :goto_1
    invoke-virtual {v3, v2}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setIsSubUser_(I)V

    invoke-static {}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->getSysteBit()I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setSysBits_(I)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v1, "client.front2"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    invoke-virtual {v3}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->getVersion_()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->getLocale_()Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lcom/huawei/updatesdk/framework/bean/startup/StartupRequest;->setSessionID(Ljava/lang/String;)V
...
.method protected onSetValue()V
    ...
    const-string/jumbo v0, "StartupRequest"
