...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/qq/e/ads/contentad/ContentAD$ContentADListener;)V
    ...
    :cond_0
    const-string/jumbo v0, "GDTContentAd Contructor paras error,appid=%s,posId=%s,context=%s"
...
.method public loadAD(IIZ)V
    ...
    :cond_0
    const-string/jumbo v0, "AD init Paras OR Context error,details in logs produced while init ContentAD"
    ...
    const-string/jumbo v1, "page_number"
    ...
    const-string/jumbo v1, "is_manual_operation"
    ...
    :cond_3
    const-string/jumbo v0, "ContentAD Init error,See More Logs"
