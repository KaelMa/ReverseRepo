...
.method private a()V
    ...
    const-string/jumbo v0, "PluginFile:\t"
    ...
    const-string/jumbo v3, "e_qq_com_dex"
    ...
    const-string/jumbo v1, "exception while init plugin class loader"
...
.method static synthetic a(Lcom/qq/e/comm/managers/plugin/PM;)V
    ...
    const-string/jumbo v1, "Exception while init online plugin: "
...
.method private b()Z
    ...
    const-string/jumbo v3, "TimeStap_BEFORE_PLUGIN_INIT:"
    ...
    const-string/jumbo v2, "TimeStap_AFTER_PLUGIN_INIT:"
    ...
    const-string/jumbo v2, "FkpRHBxXILUBf4WvdE7AqCC2sdbAAWhyYN0rdUWzRmLr9Z/HL4zDYqVJXEnTK3Iav0GcYfzjwDraxe1fdUBIPXtP+AylqJUeRzvUxiZgBAfXcOhHWOca/KsU/86Uh1EPgrsSPNeCj8h9RMJX4Mm2Cwn6Wvn6qHfDOKy9ElytsOM="
    ...
    :cond_3
    const-string/jumbo v2, "Fail to prepair Defult plugin "
    ...
    :try_start_2
    const-string/jumbo v2, "Exception while init plugin manager"
...
.method private c()Z
    ...
    const-string/jumbo v3, "NextExist,Updated="
    ...
    const-string/jumbo v2, "last updated plugin version ="
    ...
    const-string/jumbo v2, ";asset plugin version=553"
...
.method private d()Z
    ...
    const-string/jumbo v3, "e_qq_com_plugin"
    ...
    const-string/jumbo v3, "update_lc"
...
.method public getFactory(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string/jumbo v2, "GetFactoryInstaceforInterface:"
    ...
    const-string/jumbo v3, "PluginClassLoader is parent"
    ...
    const-string/jumbo v2, "Fail to init GDTADPLugin,PluginClassLoader == null;while loading factory impl for:"
    ...
    const-string/jumbo v2, "factory  implemention name is not specified for interface:"
    ...
    const-string/jumbo v3, "Fail to getfactory implement instance for interface:"
    ...
    const-string/jumbo v2, "ServiceDelegateFactory ="
