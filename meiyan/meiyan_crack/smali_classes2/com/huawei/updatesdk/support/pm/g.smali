...
.method protected static a(II)V
    ...
    const-string/jumbo v2, "INSTALL_STATE"
    ...
    invoke-virtual {v1, v0}, Lcom/huawei/updatesdk/support/d/c;->c(Lcom/huawei/updatesdk/sdk/service/secure/a;)V
...
.method private static declared-synchronized b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    const-class v1, Lcom/huawei/updatesdk/support/pm/g;
    ...
    const-string/jumbo v2, "install failed!!!path is empty!!!!"
    ...
    :cond_0
    :try_start_1
    new-instance v0, Lcom/huawei/updatesdk/support/pm/b;

    invoke-direct {v0, p1, p0, p2}, Lcom/huawei/updatesdk/support/pm/b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    sget-object v2, Lcom/huawei/updatesdk/support/pm/c$a;->b:Lcom/huawei/updatesdk/support/pm/c$a;

    invoke-virtual {v0, v2}, Lcom/huawei/updatesdk/support/pm/b;->a(Lcom/huawei/updatesdk/support/pm/c$a;)V

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lcom/huawei/updatesdk/support/pm/b;->a(Z)V

    invoke-virtual {v0}, Lcom/huawei/updatesdk/support/pm/b;->d()Ljava/lang/Object;

    move-result-object v2

    if-nez v2, :cond_1

    const-string/jumbo v2, "PackageService"

    const-string/jumbo v3, "task.param is null!!"

    invoke-static {v2, v3}, Lcom/huawei/updatesdk/sdk/a/b/a/a/a;->a(Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    sget-object v2, Lcom/huawei/updatesdk/support/pm/g;->a:Lcom/huawei/updatesdk/support/pm/d;

    invoke-virtual {v2, p1, v0}, Lcom/huawei/updatesdk/support/pm/d;->a(Ljava/lang/String;Lcom/huawei/updatesdk/support/pm/b;)Lcom/huawei/updatesdk/support/pm/b;

    sget-object v2, Lcom/huawei/updatesdk/support/pm/c$b;->a:Lcom/huawei/updatesdk/support/pm/c$b;

    invoke-virtual {v0, v2}, Lcom/huawei/updatesdk/support/pm/b;->a(Lcom/huawei/updatesdk/support/pm/c$b;)V

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "install|pkg:"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    invoke-virtual {v0}, Lcom/huawei/updatesdk/support/pm/b;->e()Ljava/lang/String;
    ...
    new-instance v4, Lcom/huawei/updatesdk/support/pm/e;
    ...
    invoke-direct {v4, v5, v0}, Lcom/huawei/updatesdk/support/pm/e;-><init>(Landroid/content/Context;Lcom/huawei/updatesdk/support/pm/b;)V
