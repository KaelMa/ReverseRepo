.class final Lcom/meitu/framework/util/PermissionUtil$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/meitu/framework/util/PermissionUtil;->showCameraPerLostDialog(Landroid/os/Handler;Landroid/app/Activity;Landroid/support/v4/app/FragmentManager;)V
.end annotation
...
.method constructor <init>(Landroid/app/Activity;Landroid/support/v4/app/FragmentManager;)V
    ...
    iput-object p1, p0, Lcom/meitu/framework/util/PermissionUtil$2;->val$activity:Landroid/app/Activity;

    iput-object p2, p0, Lcom/meitu/framework/util/PermissionUtil$2;->val$fragmentManager:Landroid/support/v4/app/FragmentManager;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/meitu/framework/util/PermissionUtil$2;->val$activity:Landroid/app/Activity;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/meitu/framework/util/PermissionUtil$2;->val$fragmentManager:Landroid/support/v4/app/FragmentManager;
    ...
    iget-object v1, p0, Lcom/meitu/framework/util/PermissionUtil$2;->val$activity:Landroid/app/Activity;

    invoke-direct {v0, v1}, Lcom/meitu/framework/dialog/CommonAlertDialogFragment$Builder;-><init>(Landroid/content/Context;)V

    sget v1, Lcom/meitu/framework/framework/R$string;->camera_permission_lost_tips:I
    ...
    new-instance v2, Lcom/meitu/framework/util/PermissionUtil$2$1;

    invoke-direct {v2, p0}, Lcom/meitu/framework/util/PermissionUtil$2$1;-><init>(Lcom/meitu/framework/util/PermissionUtil$2;)V
    ...
    iget-object v1, p0, Lcom/meitu/framework/util/PermissionUtil$2;->val$fragmentManager:Landroid/support/v4/app/FragmentManager;

    const-string/jumbo v2, "CAMERA_LOST_TAG"
