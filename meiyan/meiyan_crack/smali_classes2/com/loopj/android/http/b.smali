...
.method public constructor <init>(Lorg/apache/http/conn/scheme/SchemeRegistry;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/loopj/android/http/o;-><init>(II)V
...
.method private a(Lcom/loopj/android/http/RequestParams;Lcom/loopj/android/http/n;)Lorg/apache/http/HttpEntity;
    .locals 3
    ...
    :try_start_0
    invoke-virtual {p1, p2}, Lcom/loopj/android/http/RequestParams;->getEntity(Lcom/loopj/android/http/n;)Lorg/apache/http/HttpEntity;
    :try_end_0
    ...
    invoke-interface {p2, v2, v0, v0, v1}, Lcom/loopj/android/http/n;->b(I[Lorg/apache/http/Header;[BLjava/lang/Throwable;)V
...
.method private static a(ZII)Lorg/apache/http/conn/scheme/SchemeRegistry;
    ...
    const-string/jumbo v0, "AsyncHttpClient"

    const-string/jumbo v1, "Beware! Using the fix is insecure, as it doesn\'t verify SSL certificates."
    ...
    const-string/jumbo v1, "Invalid HTTP port number specified, defaulting to 80"
    ...
    const-string/jumbo v1, "Invalid HTTPS port number specified, defaulting to 443"
    ...
    invoke-static {}, Lcom/loopj/android/http/k;->b()Lorg/apache/http/conn/ssl/SSLSocketFactory;
...
# virtual methods
.method protected a(Lorg/apache/http/impl/client/DefaultHttpClient;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;Lcom/loopj/android/http/n;Landroid/content/Context;)Lcom/loopj/android/http/c;
    .locals 1

    new-instance v0, Lcom/loopj/android/http/c;

    invoke-direct {v0, p1, p2, p3, p5}, Lcom/loopj/android/http/c;-><init>(Lorg/apache/http/impl/client/AbstractHttpClient;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/client/methods/HttpUriRequest;Lcom/loopj/android/http/n;)V

    return-object v0
.end method

.method public a(Landroid/content/Context;Ljava/lang/String;Lcom/loopj/android/http/RequestParams;Lcom/loopj/android/http/n;)Lcom/loopj/android/http/m;
    .locals 6

    invoke-direct {p0, p3, p4}, Lcom/loopj/android/http/b;->a(Lcom/loopj/android/http/RequestParams;Lcom/loopj/android/http/n;)Lorg/apache/http/HttpEntity;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/loopj/android/http/b;->a(Landroid/content/Context;Ljava/lang/String;Lorg/apache/http/HttpEntity;Ljava/lang/String;Lcom/loopj/android/http/n;)Lcom/loopj/android/http/m;
...
.method public a(Landroid/content/Context;Ljava/lang/String;Lorg/apache/http/HttpEntity;Ljava/lang/String;Lcom/loopj/android/http/n;)Lcom/loopj/android/http/m;
    .locals 7
    ...
    invoke-direct {p0, v0, p3}, Lcom/loopj/android/http/b;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lorg/apache/http/HttpEntity;)Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/loopj/android/http/b;->b(Lorg/apache/http/impl/client/DefaultHttpClient;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;Lcom/loopj/android/http/n;Landroid/content/Context;)Lcom/loopj/android/http/m;
...
.method public a(Landroid/content/Context;Ljava/lang/String;[Lorg/apache/http/Header;Lorg/apache/http/HttpEntity;Ljava/lang/String;Lcom/loopj/android/http/n;)Lcom/loopj/android/http/m;
    .locals 7
...
.method public a(Ljava/lang/String;Lcom/loopj/android/http/RequestParams;Lcom/loopj/android/http/n;)Lcom/loopj/android/http/m;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/loopj/android/http/b;->a(Landroid/content/Context;Ljava/lang/String;Lcom/loopj/android/http/RequestParams;Lcom/loopj/android/http/n;)Lcom/loopj/android/http/m;
...
.method public a(Z)V
    ...
    invoke-virtual {p0, p1, p1, p1}, Lcom/loopj/android/http/b;->a(ZZZ)V
...
.method public a(ZZZ)V
    ...
    invoke-direct {v1, p1}, Lcom/loopj/android/http/j;-><init>(Z)V
...
.method protected b(Lorg/apache/http/impl/client/DefaultHttpClient;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;Lcom/loopj/android/http/n;Landroid/content/Context;)Lcom/loopj/android/http/m;
    .locals 4
    ...
    :cond_1
    invoke-interface {p5}, Lcom/loopj/android/http/n;->a()Z
    ...
    const-string/jumbo v1, "Passed contentType will be ignored because HttpEntity sets content type"
    ...
    invoke-interface {p5, v0}, Lcom/loopj/android/http/n;->a([Lorg/apache/http/Header;)V

    invoke-interface {p3}, Lorg/apache/http/client/methods/HttpUriRequest;->getURI()Ljava/net/URI;

    move-result-object v0

    invoke-interface {p5, v0}, Lcom/loopj/android/http/n;->a(Ljava/net/URI;)V

    invoke-virtual/range {p0 .. p6}, Lcom/loopj/android/http/b;->a(Lorg/apache/http/impl/client/DefaultHttpClient;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;Lcom/loopj/android/http/n;Landroid/content/Context;)Lcom/loopj/android/http/c;
    ...
    new-instance v1, Lcom/loopj/android/http/m;

    invoke-direct {v1, v0}, Lcom/loopj/android/http/m;-><init>(Lcom/loopj/android/http/c;)V
    ...
    instance-of v2, p5, Lcom/loopj/android/http/l;

    if-eqz v2, :cond_5

    check-cast p5, Lcom/loopj/android/http/l;

    invoke-virtual {p5, p3}, Lcom/loopj/android/http/l;->a(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    check-cast v0, Lcom/loopj/android/http/m;

    invoke-virtual {v0}, Lcom/loopj/android/http/m;->c()Z
